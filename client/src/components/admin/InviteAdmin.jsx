...
export default function InviteAdmin() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const res = await fetch("https://sogas-backend.onrender.com/api/auth/invite", {
                method: "POST",
                headers: {
    ...
    return (
        <div className="bg-deep-blue border border-soft-blue rounded-xl p-6 mb-8">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <button 
                    type="submit"
                    disabled={loading}
                    className="bg0soft-blue hover:bg-light-blue text-dark-navy font-semibold px-6 py-3 rounded-lg transition"
                >
